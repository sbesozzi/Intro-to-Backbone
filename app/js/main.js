...
var people = new _people_collection2['default']();
...
function renderPeople() {
  ...
  people.each(function (person) {
    ...
    var templateString = (0, _person_template2['default'])(data);
    console.log('templateString');

    var $li = (0, _jquery2['default'])((0, _person_template2['default'])(data));
...
},{"./people_collection":2,"./person_template":4,"jquery":6,"moment":7,"underscore":8}],2:[function(require,module,exports){
'use strict';
